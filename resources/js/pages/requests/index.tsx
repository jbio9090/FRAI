    ...
    return (
        <DefaultLayout hasPadding={false}>
            <div className="max-w-7xl mx-auto w-full">
                ...
                <div className="flex flex-col justify-center w-full mt-4 flex-wrap gap-4  px-4 md:px-8">
                ...
                <AnimatePresence>
                    {selected.length > 0 && isBulkCommentOpen && (
                        <motion.div
                            ...
                            className="w-full mt-4 mb-2 overflow-hidden px-4 md:px-8"
                        >
                            <Field>
                ...
                <Deferred data="requests" fallback={<RequestsSkeleton />}>
                    <>
                        ...
                        <div
                            className="gap-4 mt-8 flex flex-col sm:grid items-stretch w-full p-2 sm:px-4 md:px-8"
