...
2. Fetch the PHPUnit 11.5.50 documentation at `https://phpunit.de/documentation.html` for the assertions of PHPUnit for a plain value, a type, a format, or a shape.
