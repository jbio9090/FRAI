...
<head>
    ...
    <title>Request Status Update - {{ config('app.name') }}</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="text-align: center;">
                                        ...
                                        <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 700; letter-spacing: -0.025em;">Request {{ ucfirst(str_replace('_', ' ', $status)) }}</h1>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                                <tr>
                                    <td style="background: #f8fafc; border-radius: 8px; padding: 20px; border-left: 4px solid {{ $iconColor }};">
                                        <p style="margin: 0; color: #374151; font-size: 15px;">{{ $statusMessage }}</p>
                                    </td>
                                </tr>
                            </table>
